...
const debug = require('debug')('podcast-skill');
...
exports.register = function register(skill) {
  ...
  skill.onIntent('AMAZON.StopIntent', () => ({ to: 'stop' }));

  skill.onIntent('AMAZON.PauseIntent', () => ({ to: 'stop' }));

  skill.onIntent('AMAZON.CancelIntent', () => ({ to: 'stop' }));
